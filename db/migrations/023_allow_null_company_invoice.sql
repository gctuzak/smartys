-- Make company_id nullable in faturalar table
ALTER TABLE "faturalar" ALTER COLUMN "company_id" DROP NOT NULL;

-- Update fatura_olustur function to handle null company_id
