...
ALTER TABLE "products" ALTER COLUMN "stok_miktari" TYPE decimal(10,2);
ALTER TABLE "fatura_kalemleri" ALTER COLUMN "miktar" TYPE decimal(10,2);
ALTER TABLE "stok_hareketleri" ALTER COLUMN "miktar" TYPE decimal(10,2);

-- Update fatura_olustur function to handle decimal quantities
